      ...
      {isExpanded && <div className="p-4 space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 sm:gap-4">
            ...
            <div className="text-center p-2 sm:px-4 sm:py-3 bg-highlight-light rounded-lg">
              ...
              <p className={cn("font-mono font-bold text-xs sm:text-base", saldoDisponivel >= 0 ? 'text-highlight' : 'text-expense')}>{formatCurrency(saldoDisponivel)}</p>
            </div>
            <div className="text-center p-2 sm:px-4 sm:py-3 bg-future-light rounded-lg">
              ...
              <p className={cn("font-mono font-bold text-xs sm:text-base", saldoComFuturos >= 0 ? 'text-future' : 'text-expense')}>{formatCurrency(saldoComFuturos)}</p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-4">
              ...
              <div className="text-center p-3 sm:p-4 bg-future-light rounded-lg border border-future/20">
                ...
                <p className={cn("font-mono font-bold text-lg sm:text-xl", totalAPagarComFuturos > 0 ? 'text-future' : 'text-income')}>
                  {totalAPagarComFuturos > 0 ? formatCurrency(totalAPagarComFuturos) : formatCurrency(Math.abs(totalAPagarComFuturos)) + ' ✓'}
                </p>
          ...
          {faltaDepositar > 0 && <div className="mt-3 pt-3 border-t border-border">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4">
                ...
                <div className="text-center p-3 sm:p-4 bg-future-light rounded-lg border border-future/20">
                  ...
                  <p className={cn("font-mono font-bold text-lg sm:text-xl", faltaDepositarComFuturos > 0 ? 'text-future' : 'text-income')}>
                    {faltaDepositarComFuturos > 0 ? formatCurrency(faltaDepositarComFuturos) : formatCurrency(Math.abs(faltaDepositarComFuturos)) + ' ✓'}
                  </p>
