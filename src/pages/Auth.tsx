...
export default function Auth() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    const {
      error
    } = await signUp(registerUsername, registerEmail, registerPassword, registerDisplayName || registerUsername, registerFullName, registerPhone, registerCity);
    if (error) {
      toast.error(error.message);
      setIsLoading(false);
      return;
              ...
              <form onSubmit={handleLogin} className="space-y-3 sm:space-y-4">
                <div className="space-y-1.5 sm:space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="login-username" type="text" placeholder="Digite seu usuário" value={loginUsername} onChange={e => setLoginUsername(e.target.value)} className="pl-10 h-10 sm:h-11 text-sm sm:text-base" autoComplete="username" disabled={isLoading} />
                  </div>
                </div>
                ...
                <div className="space-y-1.5 sm:space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="login-password" type={showPassword ? 'text' : 'password'} placeholder="Digite sua senha" value={loginPassword} onChange={e => setLoginPassword(e.target.value)} className="pl-10 pr-10 h-10 sm:h-11 text-sm sm:text-base" autoComplete="current-password" disabled={isLoading} />
            ...
            <TabsContent value="register">
              <form onSubmit={handleRegister} className="space-y-3 sm:space-y-4">
                <div className="space-y-1.5 sm:space-y-2">
                  ...
                  <div className="relative">
                    <User className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                    <Input id="register-username" type="text" placeholder="Escolha um nome de usuário" value={registerUsername} onChange={e => setRegisterUsername(e.target.value)} className="pl-10 h-10 sm:h-11 text-sm sm:text-base" autoComplete="username" disabled={isLoading} />
                  </div>
                ...
                <div className="space-y-1.5 sm:space-y-2">
                  ...
                  <div className="relative">
                    <Mail className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                    <Input id="register-email" type="email" placeholder="seu@email.com" value={registerEmail} onChange={e => setRegisterEmail(e.target.value)} className="pl-10 h-10 sm:h-11 text-sm sm:text-base" autoComplete="email" disabled={isLoading} />
                  </div>
                </div>
                ...
                <div className="space-y-1.5 sm:space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="register-full-name" type="text" placeholder="Seu nome completo" value={registerFullName} onChange={e => setRegisterFullName(e.target.value)} className="pl-10 h-10 sm:h-11 text-sm sm:text-base" disabled={isLoading} />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="space-y-1.5 sm:space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input id="register-phone" type="tel" placeholder="(00) 00000-0000" value={registerPhone} onChange={e => setRegisterPhone(e.target.value)} className="pl-10 h-10 sm:h-11 text-sm sm:text-base" disabled={isLoading} />
                    </div>
                  </div>
                ...
                <div className="space-y-1.5 sm:space-y-2">
                  ...
                  <div className="relative">
                    <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                    <Input id="register-password" type={showPassword ? 'text' : 'password'} placeholder="Crie uma senha" value={registerPassword} onChange={e => setRegisterPassword(e.target.value)} className="pl-10 pr-10 h-10 sm:h-11 text-sm sm:text-base" autoComplete="new-password" disabled={isLoading} />
                    <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground">
                      {showPassword ? <EyeOff className="h-4 w-4" /> : <Eye className="h-4 w-4" />}
                    </button>
                  </div>
                ...
                <div className="space-y-1.5 sm:space-y-2">
                  ...
                  <div className="relative">
                    <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                    <Input id="register-confirm-password" type={showPassword ? 'text' : 'password'} placeholder="Confirme sua senha" value={registerConfirmPassword} onChange={e => setRegisterConfirmPassword(e.target.value)} className="pl-10 h-10 sm:h-11 text-sm sm:text-base" autoComplete="new-password" disabled={isLoading} />
                  </div>
                </div>
